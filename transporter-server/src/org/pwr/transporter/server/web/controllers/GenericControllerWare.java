 ...
 * @version 0.0.9
 */
public class GenericControllerWare {

    private static Logger LOGGER = Logger.getLogger(GenericControllerWare.class);
     ...
     * @return
     */
    public <T extends GenericWare> List<T> getList(IServiceWare service, HttpServletRequest request) {
